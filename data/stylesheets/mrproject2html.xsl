...
<xsl:template name="htmlfooter">
  ...
  <div class="footer-date">
    ...
    <xsl:value-of select="date:hour-in-day(date:time())"/>
	<xsl:text>:</xsl:text>
    <xsl:value-of select="date:minute-in-hour(date:time())"/>
	<xsl:text>:</xsl:text>
    <xsl:value-of select="date:second-in-minute(date:time())"/>
  </div>
  <div class="footer-disclaimer">
    <div>
      This file was generated by <a
      href="http://www.imendio.com/projects/planner/">Planner</a>
    </div>
  </div>
  </div>
</xsl:template>
    ...
    <body>
      ...
      <div class="proj-header">
        ...
        <div>
          ...
          <span class="value">
            <xsl:value-of select="date:month-name($projstart)"/>
			<xsl:text> </xsl:text>
        ...
        <div>
          <span class="header">Finish Date: </span>
          <span class="value">
            <xsl:value-of select="date:month-name($projend)"/>
			<xsl:text> </xsl:text>
			<xsl:value-of select="date:day-in-month($projend)"/>
			<xsl:text>, </xsl:text>
			<xsl:value-of select="date:year($projend)"/>
          </span>
        </div>
        <div>
		...
		<xsl:if test="@phase != ''">
          <div>
            <span class="header">Phase: </span>
            <span class="value"><xsl:value-of select="@phase"/></span>
          </div>
        </xsl:if>
