...
#define PLANNER_CELL_RENDERER_POPUP(obj)		(G_TYPE_CHECK_INSTANCE_CAST ((obj), PLANNER_TYPE_CELL_RENDERER_POPUP, PlannerCellRendererPopup))
#define PLANNER_CELL_RENDERER_POPUP_CLASS(klass)	(G_TYPE_CHECK_CLASS_CAST ((klass), PLANNER_TYPE_CELL_RENDERER_POPUP, PlannerCellRendererPopupClass))
#define PLANNER_IS_CELL_RENDERER_POPUP(obj)		(G_TYPE_CHECK_INSTANCE_TYPE ((obj), PLANNER_TYPE_CELL_RENDERER_POPUP))
#define PLANNER_IS_CELL_RENDERER_POPUP_CLASS(klass)	(G_TYPE_CHECK_CLASS_TYPE ((obj), PLANNER_TYPE_CELL_RENDERER_POPUP))
#define PLANNER_CELL_RENDERER_POPUP_GET_CLASS(obj)   (G_TYPE_INSTANCE_GET_CLASS ((obj), PLANNER_TYPE_CELL_RENDERER_POPUP, PlannerCellRendererPopupClass))
